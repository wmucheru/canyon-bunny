...
public class MenuScreen extends AbstractGameScreen {
    ...
    private Stage stage;
    private Skin skinCanyonBunny, skinLibgdx;

    // menu
    private Image imgBackground, imgLogo, imgInfo, imgCoins, imgBunny;
    ...
    private CheckBox chkMusic, chkShowFpsCounter;
    ...
    private Table buildOptWinSkinSelection () {
        ...
        selCharSkin.addListener(new ChangeListener() {
            @Override
            public void changed(ChangeEvent event, Actor actor) {
                onCharSkinSelected(selCharSkin.getSelectedIndex());
            }
        });
